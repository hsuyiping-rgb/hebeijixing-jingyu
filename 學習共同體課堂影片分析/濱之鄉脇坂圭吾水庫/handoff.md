...
- ⏯️ **做到哪**：依使用者回饋重繪封面、差異化第 4–6 頁、移除第 15/16/18/20 頁教師眼鏡，並重構第 19–21 頁總結圖；PPTX/HTML 已重跑，GitHub 已推送，Firebase 線上網站已更新
...
- ✅ **Git push**：已推 `4a58822` → `origin/main`（`hsuyiping-rgb/hebeijixing-jingyu`，私有）
