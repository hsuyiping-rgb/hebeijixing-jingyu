...
def build():
    ...
    for index, (title, claim, bullets, timestamp) in enumerate(SLIDES, 1):
        ...
        add_shape(slide, MSO_SHAPE.ROUNDED_RECTANGLE, 6.64, 0.92, 6.22, 5.52, WHITE)
        slide.shapes.add_picture(str(ILLUSTRATIONS / f"slide_{index:02d}.png"), Inches(6.74), Inches(1.02), width=Inches(6.02), height=Inches(4.62))
        text_box(slide, 10.48, 5.88, 2.28, 0.25, f"影片時間：{timestamp}", 12, GREEN)
